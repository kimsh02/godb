...
func TestLockingAcquireReadLocksOnSamePage(t *testing.T) {
...
func TestLockingAcquireReadWriteLocksOnSamePage(t *testing.T) {
	bp, hf, tid1, tid2 := lockingTestSetUp(t)
	metaLockTester(t, bp,
		tid1, hf, 0, ReadPerm,
		tid2, hf, 0, WritePerm,
...
func TestLockingAcquireWriteReadLocksOnSamePage(t *testing.T) {
	bp, hf, tid1, tid2 := lockingTestSetUp(t)
	metaLockTester(t, bp,
		tid1, hf, 0, WritePerm,
		tid2, hf, 0, ReadPerm,
...
func TestLockingAcquireReadWriteLocksOnTwoPages(t *testing.T) {
	bp, hf, tid1, tid2 := lockingTestSetUp(t)
	metaLockTester(t, bp,
		tid1, hf, 0, ReadPerm,
		tid2, hf, 1, WritePerm,
...
func TestLockingAcquireWriteLocksOnTwoPages(t *testing.T) {
	bp, hf, tid1, tid2 := lockingTestSetUp(t)
	metaLockTester(t, bp,
		tid1, hf, 0, WritePerm,
		tid2, hf, 1, WritePerm,
...
func TestLockingAcquireReadLocksOnTwoPages(t *testing.T) {
	bp, hf, tid1, tid2 := lockingTestSetUp(t)
	metaLockTester(t, bp,
		tid1, hf, 0, ReadPerm,
		tid2, hf, 1, ReadPerm,
...
func TestLockingUpgrade(t *testing.T) {
	bp, hf, tid1, tid2 := lockingTestSetUp(t)
	metaLockTester(t, bp,
		tid1, hf, 0, ReadPerm,
		tid1, hf, 0, WritePerm,
...
func TestLockingAcquireWriteAndReadLocks(t *testing.T) {
